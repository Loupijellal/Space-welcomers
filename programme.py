...
id_bouton_demarrer = canevas.create_window(largeur_ecran/2, 250, window=bouton_demarrer)
id_bouton_options = canevas.create_window(largeur_ecran/2, 300, window=bouton_options)
id_bouton_quitter = canevas.create_window(largeur_ecran/2, 350, window=bouton_quitter)
