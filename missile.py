...
class Missile_Ship :
    ...
    def __init__ (self, x, y, window, canevas, ship, boss = 0) :
        ...
        """
# Charger l'image du projectile (coeur.png)
        image = Image.open("coeur.png")
        image = image.resize((20, 20), Image.Resampling.LANCZOS)  # Ajustez la taille si nécessaire
        self.projectile_image = ImageTk.PhotoImage(image)
        ...
        self.ship_shot = self.canevas.create_image(self.x, self.y, image=self.projectile_image, anchor="nw")
